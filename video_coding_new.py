...
class coding_GUI():
    def __init__(self, init_window_name):
        ...
        self.right_of_way_listbox.place(x=1460,y=120)
        ...
        self.secondary_activity.place(x=1310,y=160)
        ...
        self.sec_checkbutton_1.place(x=1310,y=180)
        ...
        self.sec_checkbutton_2.place(x=1310,y=210)
        ...
        self.sec_checkbutton_3.place(x=1310,y=240)
        ...
        self.sec_checkbutton_4.place(x=1310,y=270)
        ...
        self.sec_checkbutton_5.place(x=1310,y=300)
        ...
        self.sec_checkbutton_6.place(x=1310,y=330)
        ...
        self.sec_checkbutton_7.place(x=1310,y=360)
        ...
        self.sec_checkbutton_8.place(x=1680,y=180)
        ...
        self.sec_checkbutton_9.place(x=1680,y=210)
        ...
        self.sec_checkbutton_10.place(x=1680,y=240)
        ...
        self.sec_checkbutton_11.place(x=1680,y=270)
        ...
        self.secondary_activity_note_entry.place(x=1730,y=160)
        ...
        self.hand_listbox.place(x=1460,y=440)
        ...
        self.reaction_t2.place(x=1310,y=520)
        ...
        self.reaction_t2_listbox.place(x=1460,y=520)
        ...
        self.weather_listbox.place(x=1460,y=640)
        ...
        self.age_group.place(x=1310,y=680)
        ...
        self.age_group_listbox.place(x=1460,y=680)
        ...
        self.save_button.place(x=1560,y=755)
    ...
    def load_video(self, event=None):
        ...
        try:
            ...
            return
        if event_id < 1 or event_id > 4779:
            return

        event_info = event_summary[event_id - 1]
        self.event_id = event_id
        self.event_info = event_info
        print("trip:", event_info[0], "start:", event_info[1], "end:", event_info[2])
        if int(event_info[0]) < 10:
            dir_string = 'V54-T0000' + str(event_info[0])
            video_string = 'Forward_054_0000' + str(event_info[0]) + '.mp4'
        elif int(event_info[0]) < 100:
            dir_string = 'V54-T000' + str(event_info[0])
            video_string = 'Forward_054_000' + str(event_info[0]) + '.mp4'
        elif int(event_info[0]) < 1000:
            dir_string = 'V54-T00' + str(event_info[0])
            video_string = 'Forward_054_00' + str(event_info[0]) + '.mp4'
        else:
            dir_string = 'V54-T0' + str(event_info[0])
            video_string = 'Forward_054_0' + str(event_info[0]) + '.mp4'
        video_path = 'D:\\V54_new\\' + dir_string + '\\' + video_string
        # print(video_path)
        ...
        self.start_frame = int((event_info[1] / 1000.0) * self.fps)
        self.end_frame = int((event_info[2] / 1000.0) * self.fps)
        reader.set(cv2.CAP_PROP_POS_FRAMES, self.start_frame)
        ...
        while have_more_frame:
            ...
            if curr_frame > self.start_frame and curr_frame <= self.end_frame:
...
def read_summary():
    workbook = openpyxl.load_workbook("event_summary.xlsx")
